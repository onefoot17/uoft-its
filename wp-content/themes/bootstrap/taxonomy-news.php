...
<h2><?php the_title();?> </h2>
<ul>
<?php query_posts('post_type=news&posts_per_page=12'); 
...
<input type="button" name="news_archive" value="View News Archive" onclick="location.href='<?php echo get_page_link(339); ?>'" />
